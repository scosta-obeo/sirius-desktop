 ...
 * @author melaasar
 */
public class ActionMenuManagerExperimental extends MenuManager {
     ...
     */
    public ActionMenuManagerExperimental(String id, IAction actionHandler) {
     ...
     */
    public ActionMenuManagerExperimental(
        String id,
